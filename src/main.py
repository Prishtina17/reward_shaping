...
if __name__ == '__main__':
    ...
    env_config_name, env_config = _get_config(params, "--env-config", "envs")
    alg_config_name, alg_config = _get_config(params, "--config", "algs")
    # config_dict = {**config_dict, **env_config, **alg_config}
    config_dict = recursive_dict_update(config_dict, env_config)
    config_dict = recursive_dict_update(config_dict, alg_config)
    config_dict["env_config_name"] = env_config_name
    config_dict["alg_config_name"] = alg_config_name
